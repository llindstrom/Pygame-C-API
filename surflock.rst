...
.. c:function:: int pgLifetimeLock_Check(PyObject *x)
   ...
   Return true if Python object x is a pgLifetypeLock_Type instance,
   false otherwise.
   This will return false on pgLifetypeLock_Type subclass instances as well.
...
.. c:function:: PyObject *pgSurface_LockLifetime(PyObject *surfobj, PyObject *lockobj)
   ...
   new pgLifetimeLockObject instance for the lock.
